...
public class CreditEditItemDialogFragment extends DialogFragment implements
	...
	public void onClick(View v) {
		...
		case R.id.button_delete:
			CreditNoteActivity act_del = (CreditNoteActivity) getActivity();
